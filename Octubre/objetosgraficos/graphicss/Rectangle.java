...
//constructor es un metodo que lleva el nombre de la clase, se llaman cuando creas , new , es una manera de crear un rectangulo
    ...
    */
    public Rectangle(double x, double y, double width, double height)//otro constructor
    {
        this.x = x;
        this.y = y;
        this.width = width;
